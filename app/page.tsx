      ...
      <main className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 pt-16 sm:pt-20 pb-20">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-xs sm:text-sm text-zinc-400 max-w-md mx-auto leading-relaxed">
            A verified community built for long-term love and marriage. Always 100% free for locals.
          </p>
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-2.5">
            <Link
              href="/login"
              className="w-full sm:w-auto rounded-xl bg-rose-600 px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-white hover:bg-rose-500 transition shadow-sm flex items-center justify-center gap-2 group"
            >
        ...
        <section className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/30 p-4">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <h3 className="text-xs font-semibold uppercase tracking-wider text-white">Smart Guardian</h3>
            </div>
          ...
          <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/30 p-4">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <h3 className="text-xs font-semibold uppercase tracking-wider text-white">Travel Radar</h3>
            </div>
            <p className="text-xs text-zinc-400 leading-relaxed">
          ...
          <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/30 p-4">
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <h3 className="text-xs font-semibold uppercase tracking-wider text-white">Spark Chemistry</h3>
            </div>
            <p className="text-xs text-zinc-400 leading-relaxed">
