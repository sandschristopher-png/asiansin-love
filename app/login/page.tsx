      ...
      {signupSuccess ? (
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 text-center space-y-4 backdrop-blur-md shadow-xl">
          ...
          <div className="rounded-xl border border-zinc-800/80 bg-zinc-950/60 p-3 text-[11px] text-zinc-400 text-left space-y-1">
            ...
            <p>3. You'll be directed to enter your profile details.</p>
          </div>
          <button
            type="button"
            onClick={() => { setSignupSuccess(false); setIsSignUp(false); }}
            className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2 text-xs font-semibold text-zinc-300 hover:text-white transition"
          >
            Back to Sign In
          </button>
        </div>
