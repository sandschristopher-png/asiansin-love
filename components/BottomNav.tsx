  ...
  return (
    <>
      <div className="sm:hidden fixed bottom-3 left-0 right-0 z-40 px-4 pointer-events-none flex justify-center">
        <nav className="pointer-events-auto bg-[#241E2F]/95 backdrop-blur-xl border border-[#725A7A]/40 rounded-2xl px-3 py-1.5 shadow-2xl shadow-black/60 w-full max-w-sm">
          <div className="grid grid-cols-4 items-center">
            ...
            >
              <div className={`p-1 rounded-xl transition-colors ${isActive('/discover') ? 'bg-[#653C87]/50 text-white' : ''}`}>
            ...
            >
              <div className={`p-1 rounded-xl transition-colors ${isActive('/favorites') ? 'bg-[#653C87]/50 text-white' : ''}`}>
            ...
            <Link
              href="/messages"
              className={`flex flex-col items-center justify-center py-1 transition-all active:scale-90 relative ${
                isActive('/messages') ? 'text-white' : 'text-[#8E7B99] hover:text-[#DDD8D4]'
              }`}
            >
              <div className={`p-1 rounded-xl transition-colors relative ${isActive('/messages') ? 'bg-[#653C87]/50 text-white' : ''}`}>
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              <div className={`p-1 rounded-xl transition-colors ${accountSheetOpen ? 'bg-[#653C87]/50 text-white' : ''}`}>
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
